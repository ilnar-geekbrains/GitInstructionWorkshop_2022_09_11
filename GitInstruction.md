...
## Работа с удаленными репозиториями.
 ...
 Ответ: Работа с удаленными репозиториями необходимо для того чтобы была возможность вести программирование с разных компьтеров
   Можно вести колллективную работу 
   отправлять репозитории со своего компютера на другое 
   этой ветке создаем описание для вопроса с удаленными репозиториями немного поспешил при работе и случайно не создал ветку по которому собираюсь сделать пул реквест 
 Добалю еще немного описание в этом документе для надежности 
