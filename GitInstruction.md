...
***`git init`***
Эта команда создает скрытую папку `.git`  с дочерними папками в которых и будет производиться сохранение версий файлов в репозитории. Удаление папки `.git` равнозначно удалению репозитория.
