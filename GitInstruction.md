...
# Немного креатива про ГИТ:
Сотрите ***дети*** это Гит

Он на сервере **лежит**

И рассматривает в лупу

Как ты коммитишь ченжи тупо..

## Посмотри на картинку
![](Clipboard04.jpg)
Однажды жил был ***герой***. Пошёл он как-то убивать дракона и дракон убил его. Совсем, потому что герой не засэйвился. Герою пришлось:
1.  Заново воплотиться в мире
2. Вырасти здоровым и сильным
3. Снова захотеть замочить дракона
4. Найти волшебника по имени Гит, который в случае неудачного боя мог бы вернуть героя в здоровое состояние.
И дела пошли намного лучше!

## Если быть более точными

![](Clipboard05.jpg)
 ### На этой картинке можно посмотреть, как именно может отработать Git, если бы работа была игрой.. Хм.. Только Git - круче! Он, походу, может сэйвить сетевую игру с большим числом участников! Об этом, видимо будет написано в следующих коммитах.

Ах, да. В этом файле уже есть всё про команды гита  для работы с удалёнными репозиториями. Не хочется соперничать с их автором.