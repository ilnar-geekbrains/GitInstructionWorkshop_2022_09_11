...
Нужна для возможности хранения различных версий проекта и возможности возвращаться к различным версиям
...
Преимущества:
1. Система на основе CVS
2. Допускает атомарные операции
3. Операции с ветвлением кода менее затратны
4. Широкий выбор плагинов IDE
5. Не использует пиринговую модель
Недостатки:
1. Все еще сохраняются ошибки, связанные с переименованием файлов и директорий
2. Неудовлетворительный набор команд для работы с репозиторием
3. Сравнительно небольшая скорость