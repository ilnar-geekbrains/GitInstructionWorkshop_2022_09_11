...
*Создание ветки* __git branch <branch_name>__
*Переключиться на ветку:* __git checkout <branch_name>__
*Создание и переключение на ветку:* __git checkout -b <branch_name>__
*Удаление ветки:* __git branch -d <branch_name>__
*Смержить ветку <branch_name> с текущей веткой:* __git merge <branch_name>__
*Переименновать ветку:* __git branch -m <new_name>__
