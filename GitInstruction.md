...
# Действия для работы с удаленным репозиторием:
1)Создаем аккаунт на GitHub

2)Создаем локальный репозиторий

3)"Подружить" ваш локальный репозиторий и укдаленный репозиторий

4)Пушнуть ваш локальный репозиторий в удаленный(на Github), при этом может потребоваться авторизация на удаленном компьютере
