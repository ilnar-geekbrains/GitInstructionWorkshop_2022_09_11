...
git branch - выодит список всех веток и * и цветом показывает, на какой ветки вы находитесь

__git branch *branch_name*__ - создание новой ветки

__git checkout *branch_name*__ - переход на ветку

__git merge *branch_name*__ слияние с текущей веткой

__git branch -d *branch_name*__ - удаление слитой ветки

__git branch -D *branch_name*__ - удаление любой ветки, независимо от ее слияния
