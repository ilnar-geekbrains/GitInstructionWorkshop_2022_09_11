...
Для того, чтобы сохранять различные версии одного и того же файла. 
Тогда при необходимости изменений рабочая версия файла не будет утеряна, и к ней можно будет вернуться.
