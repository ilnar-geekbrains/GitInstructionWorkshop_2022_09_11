...
1. репозиторий - хранилище файлов (папка) поддерживающее версионность.
2. что-бы создать локалный репозиторий:
    * нужно создать папку в любом удоном месте
    * войти в эту папку используюя терминал
