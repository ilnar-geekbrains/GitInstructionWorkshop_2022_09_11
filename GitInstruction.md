...
Программа, которая сохраняет и хранит состояние проекта(в частности файлов) в определенные моменты времени,
позволяя возвращаться к любым из этих сохраненных состояний, а также отслеживает кто и когда эти изменения внес.
