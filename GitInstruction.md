...
Репозиторий - это хранилище файлов, поддерживающее версионность. Для создания локального репозитория, нужно открыть папку, где будет располагаться репозиторий, в VSC, открыть терминал и набрать команду git init. В этой папке будет настроена система контроля гит. 
