...
1. Для работы с удаленным репозиторием нужно зарегистрироваться на сайте [GitHub](https://github.com)
2. На сайте GitHub нужно создать новый репозиторий и один любой файл
3. Делаем git clone для нашей локальной версии
4. Обязательно переходим для работы в нужную папку командой cd
5. Вносим нужные изменения в  репозиторий
6. Коммитим
7. Отправляем в удаленный репозиторий локальную версию командой git push

## Работа с форком интересующего репозитория 

1. Делаем форк (fork) интересующего репозитория
2. Делаем git clone для нашей версии
3. Создаем новую ветку с нашими изменениями
4. Производим все изменения только в нашей ветке
