...
Для работы с ветками используйте команду Git branch.
Для перехода между ветками используйте команду Git checkout name_branch
Для создания ветки команду Git branch new_branch
