...
Это система, позволяющая сохранять все изменения работы с файлом. Особенность этой системы в том, что каждый раз сохраняется не файл целиком, а лишь ее изменения, что позволяет экономить память ПК.  
