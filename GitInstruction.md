...
Система контроля версий нужна для одновременной работы над одним проектом/текстом нескольким людям, к примеру, в опен-сорс проекте. Основная функциональная задача системы контроля версий заключается в возможности легкого перемещения между разными версиями/сохранениями.
